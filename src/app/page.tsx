...
import Navbar from "./(customer)/(index)/components/Navbar";
import Category from "./(customer)/(index)/components/Category";
import Product from "./(customer)/(index)/components/Product";
import Brand from "./(customer)/(index)/components/Brand";
import Footer from "./(customer)/(index)/components/Footer";
